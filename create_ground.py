...
def create_ground(NEST_SIZE_X, NEST_SIZE_Y, CACHE_SIZE_Y, SLOPE_SIZE_Y, SLOPE_ANGLE, SOURCE_SIZE_Y):
    ...
    JOINT_CACHE_SLOPE_POSE_Y = NEST_SIZE_Y/2 + CACHE_SIZE_Y
    ...
    pose_joint_slope_source.text = f'{JOINT_CACHE_SLOPE_POSE_X} {JOINT_CACHE_SLOPE_POSE_Y} {JOINT_CACHE_SLOPE_POSE_Z} 0 {SLOPE_ANGLE} 0'
    ...
    pose_joint_slope_source.text = f'{JOINT_SLOPE_SOURCE_POSE_X} {JOINT_SLOPE_SOURCE_POSE_Y} {JOINT_SLOPE_SOURCE_POSE_Z} 0 {-SLOPE_ANGLE} 0'
